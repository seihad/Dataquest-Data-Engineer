...
# cur = conn.cursor()
# cur.execute("""
# CREATE INDEX state_index ON homeless_by_coc(state);
# """)
# conn.commit()
# cur.execute("""
# EXPLAIN (FORMAT json)
...
# conn.commit()
# cur.execute("""
# SELECT * FROM homeless_by_coc WHERE LOWER(measures) = 'total homeless';
# """)
...
# conn.commit()
# cur.execute("""
# SELECT * FROM homeless_by_coc WHERE state = 'CA' AND count = 0
# """)
